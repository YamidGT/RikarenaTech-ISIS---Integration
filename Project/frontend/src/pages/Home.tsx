...
export const Home: React.FC = () => {
    ...
    return (
        <section className="w-full  bg-neutral-50 flex flex-col items-center">
            ...
            <div
                className="w-full max-w-[1184px] bg-neutral-100 border border-neutral-200 shadow-sm rounded-lg mt-10 px-4 py-4 flex flex-wrap items-center justify-between gap-4">
                ...
                Categoría:
                    ...
                    <button
                        className="px-3 py-2 hidden sm:flex text-sm font-medium text-neutral-900 rounded-md hover:bg-neutral-200">
                        Verduras
                    </button>
                </div>
