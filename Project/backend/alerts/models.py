...
class Alert(models.Model):
    ...
    municipality = models.ForeignKey(Municipality, on_delete=models.CASCADE, null=True, blank=True, related_name='alerts')
    ...
    image = models.ImageField(upload_to='alerts/%Y/%m/%d/', null=True, blank=True, help_text='Alert image or screenshot')
